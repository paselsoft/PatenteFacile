...
export const Header: React.FC = () => {
  ...
  return (
    <header className="bg-gradient-to-br from-motorizzazione to-blue-800 text-white pb-16 pt-20 rounded-b-[3rem] shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-white opacity-[0.03] rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-accent-green opacity-[0.05] rounded-full blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button 
                    ...
                    className="group bg-accent-green hover:bg-emerald-400 text-white text-lg font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-emerald-500/30 transition-all duration-300 transform hover:-translate-y-1 flex items-center"
                >
                ...
                <button 
                    onClick={() => document.getElementById('procedura')?.scrollIntoView({ behavior: 'smooth' })}
                    className="group bg-white/10 hover:bg-white/20 text-white text-lg font-medium py-4 px-8 rounded-full backdrop-blur-sm border border-white/20 transition-all duration-300 flex items-center"
                >
                    Scopri i Passaggi
